...
class ConfigurationTreatmentType extends TranslatorAwareType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('configuration_treatment_url', TextType::class, [
                'label' => $this->trans(
                    'Treatment > URL',
            ...
            ->add('configuration_treatment_biding', TextType::class, [
                'label' => $this->trans(
                    'Treatment > Biding',
                    'Modules.Salusperaquam.Admin'
                ),
            ...
            ->add('configuration_treatment_resource', TextType::class, [
                'label' => $this->trans(
                    'Treatment > Resource',
                    'Modules.Salusperaquam.Admin'
                ),
    ...
    {
        return 'configuration_treatment_general_block';
    }
