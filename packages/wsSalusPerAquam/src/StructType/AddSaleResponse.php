...
/**
 * This class stands for AddSaleResponse StructType
 * @subpackage Structs
 * @version 1.0
 * @date 2022/04/01
 */
class AddSaleResponse extends AbstractStructBase
{
    /**
     * The Result
    ...
    public $Success;
    /**
     * Constructor method for AddSaleResponse
     * @uses AddSaleResponse::setResult()
     * @uses AddSaleResponse::setSuccess()
