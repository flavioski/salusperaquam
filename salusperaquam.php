...
class SalusPerAquam extends Module
{
    public $configurationList = [
        ...
        'SALUSPERAQUAM_CONFIGURATION_TEST_PORT' => '123',
        'SALUSPERAQUAM_CONFIGURATION_TEST_FACILITY_ID' => '123456',
        'SALUSPERAQUAM_CONFIGURATION_TEST_USERNAME' => 'username-test',
        'SALUSPERAQUAM_CONFIGURATION_TEST_PASSWORD' => 'password-test',
        'SALUSPERAQUAM_CONFIGURATION_TEST_CLIENT_ID' => 'AABBCCDDEEFFGGHHII',
        'SALUSPERAQUAM_CONFIGURATION_TEST_USER_TYPE' => '1',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION' => '0',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_PROTOCOL' => 'https',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_HOST' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_PORT' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_FACILITY_ID' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_USERNAME' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_PASSWORD' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_CLIENT_ID' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_USER_TYPE' => '',
    ];
