...
class SalusPerAquam extends Module
{
    public $configurationList = [
        ...
        'SALUSPERAQUAM_CONFIGURATION_TEST_SEAT_ID' => '0000',
        'SALUSPERAQUAM_CONFIGURATION_TEST_USERNAME' => 'demo',
        'SALUSPERAQUAM_CONFIGURATION_TEST_PASSWORD' => 'demo',
        'SALUSPERAQUAM_CONFIGURATION_TEST_USERTYPE' => '000',
        'SALUSPERAQUAM_CONFIGURATION_TEST_SESSION_ID' => '1234567890',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION' => '0',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_URL' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_SEAT_ID' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_USERNAME' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_PASSWORD' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_USERTYPE' => '',
        'SALUSPERAQUAM_CONFIGURATION_PRODUCTION_SESSION_ID' => '',
        'SALUSPERAQUAM_CONFIGURATION_LOGIN_URL' => '',
        'SALUSPERAQUAM_CONFIGURATION_LOGIN_BIDING' => '',
        'SALUSPERAQUAM_CONFIGURATION_LOGIN_RESOURCE' => '',
        'SALUSPERAQUAM_CONFIGURATION_USER_URL' => '',
        'SALUSPERAQUAM_CONFIGURATION_USER_BIDING' => '',
        'SALUSPERAQUAM_CONFIGURATION_USER_RESOURCE' => '',
        'SALUSPERAQUAM_CONFIGURATION_TREATMENT_URL' => '',
        'SALUSPERAQUAM_CONFIGURATION_TREATMENT_BIDING' => '',
        'SALUSPERAQUAM_CONFIGURATION_TREATMENT_RESOURCE' => '',
        'SALUSPERAQUAM_CONFIGURATION_TREATMENT_RESOURCE_GET_TREATMENT' => 'GetTreatment',
        'SALUSPERAQUAM_CONFIGURATION_SALE_URL' => '',
        'SALUSPERAQUAM_CONFIGURATION_SALE_BIDING' => '',
        'SALUSPERAQUAM_CONFIGURATION_SALE_RESOURCE' => '',
        'SALUSPERAQUAM_CONFIGURATION_SALE_RESOURCE_ADD_SALE' => 'AddSale',
        'SALUSPERAQUAM_CONFIGURATION_RESERVATION_URL' => '',
        'SALUSPERAQUAM_CONFIGURATION_RESERVATION_BIDING' => '',
        'SALUSPERAQUAM_CONFIGURATION_RESERVATION_RESOURCE' => '',
    ];
